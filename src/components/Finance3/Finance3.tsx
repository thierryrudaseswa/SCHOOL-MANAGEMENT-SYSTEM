...
const FinanceCo = () => {
  ...
  return (
    <div className="grid grid-cols-12 gap-4">
     <div className=" scroll left col-span-8 bg-white rounded-3xl overflow-y-scroll" style={{height:"89vh"}}>
        <div className="head h-20  grid justify-center items-center">
           <div className=" bg-white w-52 grid items-center justify-center"> <h1 className=" font-bold text-lg">Balance</h1>
        ...
        <div className="income ">
            <div className=" h-12 bg-white  flex justify-start items-center font-extrabold p-2">Expenses</div>
            <div className="ex grid grid-cols-3  h-16 items-center justify-center font-bold p-4 rounded-2xl m-4 " style={{}}>
               ...
               <div className="ex grid grid-cols-3 h-16 items-center justify-center font-bold p-4 rounded-2xl m-4">
                <div className="head col-span-1">Salary</div>
                <p className=" col-span-1">Today</p>
            ...
            <div className=" h-12 bg-white  flex justify-start items-center font-extrabold p-2">Income</div>
            <div className="ex grid grid-cols-3 h-16 items-center justify-center font-bold p-4 rounded-2xl m-4 " style={{}}>
                <div className="head col-span-1">Salary</div>
                <p className=" col-span-1">Today</p>
                <div className="col-span-1 flex justify-end"><button className=" h-9 rounded-full text-white" style={{background:"#2B59FF",width:"150px"}}> -300$</button></div>
     ...
     <div className="scroll right col-span-4 bg-white rounded-lg overflow-y-scroll">
        <div className="rec ">
