  ...
  return (
    <div className="relative flex items-start gap-3">
      <div className="flex flex-col gap-1">
        <div className="flex flex-col w-full max-w-[326px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700 relative">
          ...
          <p className="text-sm font-normal text-gray-900 dark:text-white">This is a sample text.</p>
