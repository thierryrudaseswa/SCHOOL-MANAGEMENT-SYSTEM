  ...
  return (
    <div>
      ...
      <div className=" grid grid-cols-7 gap-10">
        <div className=" col-span-3" style={{height:"600px"}}></div>
        <div className=" col-span-4 pr-20 font-semibold gap-2 mb-2">
            <div className=" p-20">SMS is a digital platform that helps educational institutions efficiently manage student data, academic records, attendance, communication, and administrative tasks. It streamlines operations, enhances communication between teachers, parents, and students, and provides easy access to essential information for improved educational management</div>
            
            <div className="p-20 mt-10 flex flex-wrap gap-20">
