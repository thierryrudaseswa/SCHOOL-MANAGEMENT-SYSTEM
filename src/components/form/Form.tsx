...
<Button />
      ...
      <div className="">
        ...
        <div className="mt-2">
          <input id="password" name="password" placeholder='password' type="password" autoComplete="current-password" required className="block h-16 rounded-full border-0 py-1.5 px-5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"  style={{width:"450px"}}/>
        </div>
