...
const Form:React.FC<Props> = ({isSignUp,isAdmin}) => {
  return (
    <div className="p-0 h-screen  flex justify-center">
      <div className="flex my-5 flex-col bg-white rounded-xl justify-center px-6 lg:px-8">
...
<Button />
      ...
      <div>
        ...
        <div className="mt-2">
          <input id="email" name="email" type="email" placeholder='Enter school email' autoComplete="email" required className="block w-72 rounded-lg border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
        </div>
      </div>
      ...
      <div className="">
        ...
        <div className="mt-2">
          <input id="password" name="password" placeholder='password' type="password" autoComplete="current-password" required className="block w-72 rounded-lg border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
        </div>
      </div>
    {isSignUp && (
      <div className="">
        ...
        <div className="mt-2">
          <input id="password" name="password" placeholder='confirm password' type="password" autoComplete="current-password" required className="block w-72 rounded-lg border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
        </div>
      </div>
    )}  
