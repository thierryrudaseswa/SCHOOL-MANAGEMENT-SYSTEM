...
const Event = () => {
  return (
    <div>
         <div className="tit  flex items-center justify-center font-bold h-9">
        Previous Events
        </div>
        <div className="tab  h-40 gap-5 overflow-y-clip">
        ...
        <div className="all  h-7 font-bold flex justify-end ">All events</div>
