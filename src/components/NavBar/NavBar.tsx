...
const NavBar: React.FC = () => {
  return (
    <div className="mainNav h-24 grid grid-cols-12">
      ...
      <div className="righ col-span-9 bg flex items-center justify-end pr-4">
  <nav className="navbar h-12 grid items-center gap-2 grid-cols-6" style={{width:"800px"}}>
    ...
    <Link to="/register" className="link      h-9 flex items-center justify-center rounded-full font-bold text-white col-span-1" style={{ background: "#EE780B" }}>Register</Link>
  </nav>
</div>
    </div>
  );
